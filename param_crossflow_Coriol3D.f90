...
integer,parameter:: nx=384,ny=150,nz=(385-1)/nproc + 1
!AA End of change
...
real(rprec),parameter::z_i=1._rprec, L_z=z_i/nproc
...
!!!!!!!! Changed by AA
integer,parameter::nsteps=4 !simulation steps
!!!!!!! Ends Here
...
real (rprec), parameter :: sigma=1.9e-2_rprec, dmin=20e-6_rprec, dmax=1000e-6_rprec, d_min=1e-6_rprec,&
                           rho_c=864._rprec,nu_c=1e-6_rprec,mu_ratio=10._rprec,k_b=0.2_rprec,nu_d=1e-5_rprec
...
REAL(KIND=RPREC),parameter :: C1=1900
...
real(kind=rprec),parameter,dimension(npcon) :: settling_vel = (/3.34780488313695e-05_rprec/u_star, 5.85024736402885e-05_rprec/u_star,&
                                                               ...
                                                               0.0336604281398371_rprec/u_star/)
...
(0_rprec/(dx*z_i*dy*z_i*dz*z_i))/(PCon_scale/(z_i/u_star)),(0_rprec/(dx*z_i*dy*z_i*dz*z_i))/(PCon_scale/(z_i/u_star)),&
(0_rprec/(dx*z_i*dy*z_i*dz*z_i))/(PCon_scale/(z_i/u_star)),(0_rprec/(dx*z_i*dy*z_i*dz*z_i))/(PCon_scale/(z_i/u_star)),&
(0_rprec/(dx*z_i*dy*z_i*dz*z_i))/(PCon_scale/(z_i/u_star)),(6.047e4_rprec/(dx*z_i*dy*z_i*dz*z_i))/(PCon_scale/(z_i/u_star))/)
...
real(kind=rprec),parameter,dimension(npcon) :: densratio_pcon=(/rho_c/1018.3_rprec,rho_c/1018.3_rprec,rho_c/1018.3_rprec,rho_c/1018.3_rprec,rho_c/1018.3_rprec,&
         rho_c/1018.3_rprec,rho_c/1018.3_rprec,rho_c/1018.3_rprec,rho_c/1018.3_rprec,rho_c/1018.3_rprec,&
         rho_c/1018.3_rprec,rho_c/1018.3_rprec,rho_c/1018.3_rprec,rho_c/1018.3_rprec,rho_c/1018.3_rprec/)
!AA Change ends here
...
1.1977e-13_rprec,2.7696e-13_rprec,6.4044e-13_rprec,1.481e-12_rprec,3.4246e-12_rprec,7.9191e-12_rprec,1.8312e-11_rprec,& 
               4.2345e-11_rprec,9.7919e-11_rprec,2.2643e-10_rprec,5.236e-10_rprec/)

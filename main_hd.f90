...
use scalars_module,only:beta_scal,obukhov,theta_all_in_one,RHS_T,RHS_Tf,pollen_all_in_one2,scale_us,deposition,Real_dep,P_surf_flux,P_surf_flux_dep,beta_pcon
...
!DY***********************************
!DY Modified by Di Yang for higher resolution simulations
!DY Start here
